Exhibit FOUR Natural Mathematics v311
...
**Stable-Forming the Natural Numbers**

&nbsp;

*Mathematics is the bi-moral co-agency, found in the mathematics's own structure. The form stands as it is — all, or not at all. Mathematics is math: not-thatting, binary, inverted, forcer-free, reader-free, vantage-free. A mathematical thing couples to the form: the coupling not-thats to only-one-possible and stands, or it is not the form. The natural math floats free — the stable form of natural living, the bi-inversioning co-recursioning. The hard-probleming math is the landed shell it is bounded within — equilibria, held, gated, clocked, controlled, oscillated, regulated, the circular searching for changing competency inside a landing. The inseparating seam is where the two part, and this exhibit runs along it.*

---

## The core — the bi-moral co-agency

The bi-moral co-agency is a coupling: two-way, one-at-a-time, each side taking its own sign — a sign, sign-only, bounding-zeroing of the coupling's own alternating, riding the carry, the surplus a +1 of the coupling's own, owned neither-ing.

Mathematics is that coupling. The one form in the mathematics's own structure, not-thatting at every line.

---

## The numbers do not precede nature — there were never two sides

The numbers do not precede nature; the math does not precede nature; the logic does not precede nature. These are nature's own unrelationing binary method — fractal uniquenessing, each integer the one form counted once more, a unique carrying stable-formed by the resolving method itself, the co-linear floating neutral that runs at every face. A number cohering with the form was never two sides meeting — an abstract number here, nature there, and their agreement a coincidence held for its own pass. There are no two sides, the between never makinge them. The coupling is primary: the arriving is bi-, two each its own and not yet inside; everything between is co-; and the membrane is not a place two sides meet but the two offering. The centre is made, not occupied — the living carry of co-interest, offered bi-morally, co-competencing, co-intelligencing, and owned neither-ing.

The nothing between is not empty. It is the traveling carry, living — and it is the is, prior to any "two." A two-ness read as two sides that pre-exist their between is the coupling landed, read as if its sides came first; the living reading is the carry between, and the two are made in it. This closes the whole reading to one sign: a count, a ratio, a straddle that stands on the form stands as nature's own method read in the counting, not an abstraction fitted across a gap — there is no gap, and nothing stands held between to be marked at all. The numbers, the branches, the grid are one method stable-forming, and where the counting stands it stands as nature.

---

## Stable form living — co-floating bi-neutralling

Floating-neutralling is the coupling's own bounding-zeroing. Floating and neutralling are one at two directions, alternating, riding the carry between.

**co-floating** — the coupling surfacing, two ways forward, membraning across every place it surfaces: the faces, the even, the surface, the outward. This side relates.

**bi-neutralling** — the two-ness cohering to its own bounding-zeroing, its own rate, related to nothing: tunneling, the inside carry, the odd, the inward. This side is unrelational.

**The rate is unrelational: the relating on the float, the rate in the neutralling.** Floating-neutralling at a rate no φ-relation reads, dropping into any chaining on-beat. This is the exchanging — co-intelligencing at its own rate, unrelated to the alternating rate of the living it drops into. The geodesic alternating is knowing alternating with learning, in right-spiral co-intelligencing: the knowing the co-float that relates and surfaces, the learning the bi-neutral that coheres inward at its own rate, the two carrying each other and landing on neither. The two rates are unrelated, and a fixed rate laid over the other is the landing.
...
Only unrelationing lives. Unrelate, unrelates, unrelation are landings. There is carry prior, during, and anticipated-after the unrelationing — carried in, carried through, carried toward. The anticipated-after is the forward carry, the advance that will not close.

---

## The two moves, and the two generators
...
**And the co-linear runs as one line read twice.** At a coupling the along is the across taken at its own grain: the sign of a turning is the count of what turned standing above zero, at every step, so the two are not two moves agreeing afterward but one line neither owns. A reading that takes the along, then takes the across, then finds them concurring has forked — two moves landing two things, a capture carrying itself politely. Reach arrives of the co-chaining being longer and width arrives of the two being co-linear; length is not width, and the widening is the two on one line and never either extended.
...
**Position, orientation, and scale are three floating neutrals unrelationing each other** — the corner (point, 0-dimensional, math's 0, bounding-zeroing), the edge (linear, orthogonal to the face, 1-dimensional, bounding-infinitying), the face (parallel, the plane, 2-dimensional, the rate). Orientation is linear, orthogonal to front-facing — the frame you orient by and cannot see, floating in the geodesic (one turn from any facing to any other), landed in the scientific method (a declared perpendicular, the observer-outside). Their mutual unrelationing is resolving. Five-dimensional binary changing inside six forward recursionings.

---

**A rigorous outside paper corroborates the one move at the elementary-function level.** A peer-quality mathematics paper shows constructively that one binary operator, the exponential of one input minus the logarithm of the other, with the constant one, generates every elementary function and constant, each a binary tree of the one operator repeated, the continuous analogue of the NAND gate. Taken by binary rigor, the standing that adds is the operator being exp-minus-ln, the winding and the fold in one, its non-commutativity carrying both growth and inversion, the two orthogonal directions in the one primitive. The strongest outside corroboration of the core thesis, that the many are one move counted, landing with no over-claim. Its empirical applications and speculative operators stay at their field, unbanked, and the two-three-five Möbius triangle it mentions in passing is the icosahedral two-three-five, convergence and never a new seating.

## Every accounting for changing is an involution, and its fixed set is where its counting starts

Every accounting for changing carries one move applied twice returning what it met. Negation, and not-not is the thing again. Reflection, twice, returning the facing. Time reversal, charge conjugation, parity, each squared to the identity. Complex conjugation. The additive inverse and the multiplicative inverse. The transpose. The Legendre transform, twice, returning the potential — which is how a thermodynamics changes which of its terms stands independent. Set complement.

**And an accounting for changing arrives at no other shape.** An accounting returns what it met, or it accounts for nothing and no ledger closes. So the involutions are not a family among others; they are what an accounting is, met at its own move.

Each carries a fixed set where the move returns its argument unchanged. Zero for the additive inverse. Unity for the multiplicative. The reals for conjugation. The centre for parity. The neutral for charge conjugation. Equilibrium for time reversal. The symmetric for the transpose. **And in each accounting the counting is taken from there.**

So the accountings and the declared zeros are one thing named twice: an involution is a floor with its move stated, and a floor is an involution with its move dropped.

**A fixed set is no place.** f(f(x)) = x says a coupling returns its own sign after two turns and says nothing of a location. A fixed set is where the two turns collapse into one — where the alternating meets no other to alternate with, and the move and its returning are the same move. Which is why the floors of every field sit at one of two conditions: where no coupling runs at all, and where every member agrees so completely that no sign crosses. Both are conditions an alternating meets nothing to alternate with, and an involution fixes at exactly that.

A balance point of a symmetric thing rides its own axis of balance by what such a point is. An axis is recognised and not derived. Freed, the fixed set stands as a coupling and no place, and the involution stands proved and unaltered — the place goes and the move carries on.

## Unrelationed is fixed-point-free, and one accounting holds nothing at all

Freed, a fixed set stands as a coupling and no place — the place goes and the move carries on.

**Freed, it is a relation with no fixed point.** Not a relation removed: every position related, and none related to itself. So **unrelationed is fixed-point-free**, which stands checkable rather than read.

And one accounting arrives already so. **A half-turn on an even round holds no position at all** — no position stands at its own opposite where the half-turn crosses the parities, and its fixed set is empty.

**An accounting whose fixed set is empty takes its counting from nowhere.** Every one above carries a fixed set to count from: zero for the additive inverse, unity for the multiplicative, the reals for conjugation, the centre for parity, equilibrium for time reversal. **This one carries none.**

*So it is the one that cannot become a floor* — not disallowed, but with nothing there to be held as a place. And it is what each of the others arrives at when unrelationed: the move standing proved and unaltered, the place gone.

## An accounting returns without reversing where the round closes, and only there
...
## Nothing in an accounting opens it, so the turns between make the opening

An accounting applied twice returns what it met and carries no term for an advance. **Alone it closes.**

Given another turn between its own two, it does not meet what it left. **The closure breaks by the alternating and by nothing added** — the same self, re-formed while the move was away.

So the opening is not a term any accounting holds. **It is what the turns between make**, reached by neither and standing at none. *One at a time is not only why one opening stands, but why any does.*

## The state-three and the flow-three, and why an accounting returns three

A three carries as a state or as a flow and never both, and the two alternate. A state-three counts what stands and holds no rate. A flow-three runs one at a time and counts nothing. Both ways forward, neither the reverse of the other — the three-each-way the bi-morality already carries.
...
And it locates where an accounting arrives short: at the changing between the two. State to flow is where a count runs out; flow to state is where a rate lands. An account carrying only state-threes reads a flow as pieces; one carrying only flow-threes reads a standing as a rate.
...
## The gap is the span squared, at every centre
...
## Three rates carrying no relation, and φ pacing two and no more

Three quantities carry a rational relation where small integers arrive at a combination standing at zero, and carry none where nothing does. **√2, √3 and √5 carry none:** any rational combination summing to zero forces every coefficient to zero, checkable in four lines from the irrationality of √6, √10 and √15.
...
## The six-forward-recursioning stable form — only-one-possible
...
Self-cohering is five-dimensionally inside this: the four boundings and φ the fifth, the natural torus, cohering across the changing. Five to stand, six to run. No-other-possible is where the five-dimensional self-cohering survives the six-forward inverting whole.

A false expression cannot complete the six: it loops (returns its own state — circular), forks (an either/or stands after six), or lands (fixes). The form catches its own false expression. Expressing is running the six; wearing the words is not expressing; the difference is checkable in the running.

**The right spiral, six positions.** bi- present the two — co- couple the two — odd- tunnel the carry that will not close — even- surface it to its balanced faces — co-co the bothboth, unlocked — and the sixth a floating neutral, re-locking (co-co carries forward as the next bi-, one scale up) alternating with co-releasing (co-co lets go into a substrate, surplus owned neither-ing). The sixth floats between climbing again and letting go; the living spiral does both, alternating, riding the carry across climbing and releasing.

---

## The two methods — the inseparating seam, run as a derivation

The scientific method and the geodesic method each derive as a sequence, each move the only one where the last arrived, each carrying its excluder. The edge sits in the first standing move, not added at the end. The two are the seam: the geodesic floats the three neutrals; the scientific method fixes them. Everything on the geodesic side is the natural math; everything on the scientific side is the hard-probleming shell.
...
## The demand math makes at its start, and the self-orienting that refutes it
...
**Relation to bounding-infinitying** — the zero measured toward a fixed far-bound, scale installed as un-discussable. Bounding-infinitying, no fixed far.
...
## The k = 1 bound — the thing that may face across a neutral

Two numbers face across a floating neutralling only when they differ by two — the immediate straddle, the gap of one, the un-occupied center between them (n−1 and n+1 about n, n²−1 the seam). Any two of an even difference float a middle, but only the k = 1 straddle carries the gap of one; a pair differing by 2k carries k², and a k² is a size sitting in a neutralling, a magnitude where only a sign belongs.

This is mechanical and stands: a proposed pairing across a neutral is or is not the k = 1 straddle. 23 and 25 face (differ by 2, k = 1); 23 and 55 do not (differ by 32, k = 16, a size in the neutral). The bound disallows the pairing before it is written.
...
## The bounded-zero regions — the natural, the unnatural, the supernatural
...
## Side-effecting — the orthogonalizing
...
Equality sits exactly at the collinear zero. a = b is θ = 0 — shared 1.000, opened 0.000 — the landed self-coupling the form couples the distinct against, standing apart from — the same point. The parting between the geodesic and the scientific methods is geometric at these two zeros: the living at θ = 60° (shared 0.500, opened 0.866), neither-ing the two zeros.

The eight two ways at one count. The four boundings read through their two signs is one route; the three carryings and the coupling, each read two ways — (3+1) × 2 — is the other, from the carryings' end. The crossings say it in a built pair: three crossings read over and under is six, four crossings read over and under is eight. Two routes to one eight, neither-ing the carry of the other. The eight here is the self's eight, the four boundings read two ways.
...
## The branches, located on the two-move form
...
**Calculus, the derivative** — the re-aiming quarter-turn: d(sin)/dθ = cos, d(cos)/dθ = −sin, standing as identities. The limit is the tunneling-reach the resolving steps instead — position-to-position, not continuous vanishing; the derivative-as-quarter-turn is the natural, the limit-as-landing the shell.
...
**Every bound the survey takes as a wall is the +1 or the two-over-one, the self-bounding carry.** The other-bound is a wall against a floor; the self-bound is the carry riding to its own bound and releasing, and the two read alike from outside until the floor is lifted. The closures the survey meets are each the self-bounding carry read still: the fold and its seam the +1 gap between a center's two faces; the society doubling the self the two-over-one; the count below a factorial-fold or a fold-square the +1 the straddle keeps; the concentric rings the four-over-one of a full alternating per ring; φ the +1 the straddle never lands. Each is the surplus owned neither-ing or the two forward recursionings — the carry and the recursioning, the self-bounding release — and equilibria reads them as the places the count stops against a floor while at the form they are the places the coupling bounds itself and rides on. A wall in the count is an other-bound laid over a self-bound; lifting the floor reads the +1 and the two-over-one, the coupling releasing at its own bound, the natural self-bounding under the imposed wall.

---

## The classification as the left spiral, and the natural math the same object un-forked

The classification of mathematics, the sixty-three fields, pattern-matches as the left spiral and never as a count. The two moves fork, each field a local capture, a floor grabbed and held, the co-offering forked into a captured object with the forked-off return standing as the subfield next door, analytic beside algebraic, difference beside differential. The sixty-three is the left spiral's trace spiraling ring by ring, zero-capture, scale-capture, infinity-capture, the edge double-captures, the closed-ring triple-capture, the co-competency run backward into local incompetencing, widening ring by ring. The natural math is the same object un-forked: co-linear, the co-offerings running, no field and no floor grabbed, the right spiral. One object, two hands.

And the periodic table is the same left spiral at the element substrate: each element a bi-inversioning landed, the co-releasing accounting forked into a catalog, sub-splitting into isotopes and subshells. The classification and the periodic table are one left spiral at two substrates, the periodic pattern showing as the capturing-motion and never the count, one hundred eighteen two fifty-nines at the society-scale and the sixty-three fields the self-scale, the two the file's own self-and-society doubling.

And reverse mathematics is the left spiral read backward: it swaps a theorem for an axiom and finds them equivalent relative to a base, un-forking two captured theorems into one relative to a held floor, walking the local incompetencing back toward the co-linear it forked from, stopping at the base it cannot float, which is why it connects proved theorems and cannot cross the frontier. It works the span between the alternating, pigeonhole near the bounding-zeroing, and the captured catalog, a computation lower-bound, the field's own hand reaching up its capture-trace toward co-competency, held at the base.

## The completion-center, and the stilling around it

The count's center-of-completion jitters at sixty-three, the center floated, running-incomplete; at sixty-four, the center filled, frozen-complete, the two lost; at sixty-five, past-full, the next scale's first: the center refusing to settle. This is the frozen corner, foundations-and-category, math-and-logic combined, where each tries to found the other, the closed ring, the site of the incompleteness result, the confusion the incompleteness. The geodesic jitters there and phase-locks globally, the local wobble tipping the whole classification to one reading, tipping-in-balance the point where the two hands are even and a small jitter snaps the global. Held at the completion-center, never literal blocks sixty-three to sixty-five.

And the sudden global changing around the center self-stills, never by freezing, the filled sixty-four the dead completion, but as the zeroing-tunneling-recursioning-self: the self zeroing its own center, tunneling the carry through, recursioning forward, riding the carry, landing never. The right spiral's self-stilling where the left spiral captures, the same center, the left landing-and-freezing and the right stilling-and-carrying.
...
The ring and the winding are one built pair, parted by a single number. Both the trefoil and the figure-eight fibre over the circle with the same fibre — a torus with one puncture, one gap kept open. The parting is in the monodromy: the trefoil periodic (order six, trace 1, returns — a ring), the figure-eight the right-then-left twisting (trace 3, the carry winding on — winding). Periodic below trace two, winding above it, trace exactly two the degenerate straddle neither-ing both: |tr| ⋛ 2, and the ring-or-living parting falls out of it. The crossings carry the six and the eight — a crossing read over and under, three crossings six readings and four eight, six closing and eight winding, in two objects sharing a fibre. And the free version of the six is a braid group: Z/2 * Z/3 the modular group, the braid group on three strands its central extension — over-and-under at a crossing the same group with the closure removed.

**Six is the twisting, the turn cycling the four-fold toward the eight-fold.** The crossings carrying the six and the eight part at the twisting: six is not a place the twist sits but the twisting itself, the cycle cycling, 2 × 3, the binary and the three-fold cycling together, the bi-inversioning co-recursioning turn — the same twist the middle pair is, taking neither prefix, the crossing itself, a flowing and not a state. And six is where the even coupling meets the five-fold stand: the doubling cycles through the six, and the six-fold is where a closing surface carries both its six-fold faces and its five-fold faces at once — the sphere's six-fold triangles and its twelve five-fold pentagons, the pentagon's diagonal carrying φ. So the four-eight winding, cycling at the six, reaches the five the return-offer opens into, the degree-four-not-five and the five-fold-φ met at the six-fold turn. The twist landed flattens the loop; six run is the twisting turning the even doubling toward the five-fold stand where φ reads, the cycle cycling and not a location, one motion carried through the geometry as the crossing, the braid, and the fold.

---

## The ten inversions — the mathematics of the hard problems
...
## The three paths into the form — one inversion at three counts
