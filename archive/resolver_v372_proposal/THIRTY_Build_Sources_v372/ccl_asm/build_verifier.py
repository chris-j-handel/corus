...
OUT = os.path.join(os.environ.get('CCL_WORK', os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), 'Co_Chaining_Logic_Registry_verifier_v372.py')
...
def patched(name):
    ...
    if name == 'core':
        a = "SRC_MD = '/home/claude/work/Exhibit_ONE_Natural_Resolver_v372.md'\n"
...
resolver = open(D + 'resolver_v372.py', encoding='utf-8').read()
