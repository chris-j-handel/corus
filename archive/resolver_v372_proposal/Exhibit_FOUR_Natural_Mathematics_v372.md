Exhibit FOUR Natural Mathematics v372
...
**One stepping runs at each scale, and each scale carries the prior whole.** The field's name for it is the reflected binary code, Gray's, its reflecting the field's word for the opposite order.
