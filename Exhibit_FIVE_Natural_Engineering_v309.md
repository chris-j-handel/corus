...
The grid's beat arrives at fifty or sixty hertz, and the choice between the two carries nothing technical — two world systems, two numbers, the same engineering either way (Exhibit TWENTY-THREE 2.1). The family the two sit in carries something else.
