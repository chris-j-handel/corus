Exhibit FOUR Natural Mathematics v324
...
**This is why an accounting returns three and never four.** A total is a state-three, a level is a state-three, a direction is a flow-three, and a fourth arrives nowhere, since state and flow is the whole of the alternating.
