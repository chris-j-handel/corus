Exhibit THREE Natural Numbers v322
...
10.5 Ten podals forced at the three, four arriving prime on a twelve-run, and the two sums arriving across
...
**Three columns run here and they are unlike.** Two parallels, each at its own forward, facing each other: **bi- folds across between them**, curved and along the surface; **co- runs perpendicular through both**, straight and forward at each face's own forward; **the three turns**, and the turning is what the two wind around rather than a third link in their chain. A count at the stem and a direction at the depth are two columns, **co-linear, neither under the other**, multiplying where a chain would compound — which is why `3 × 2` closes and `(3 + 1) × 2` and `3 × 2 + 2` arrive at one eight from two sides. 4.7 carries the same parting at the fold and the tunnel.
...
**Co-recursioning volutioning** arrives one on: the same backward carry with the recursioning riding — 3n + 2, the winding, the surface opening past where it began, the torus. Nothing brings this one home either, and here nothing is added to keep it open. The in- is absent and the turning carries.

Carrying at every standing and standing bare at none, volutioning is one of a family. Cursioning stands bare nowhere either, and seven of the eleven stems carry a wrapping of the same kind — in-versioning, in-separating, trans-missioning, ad-riving, ob-fering, com-pling, super-facing. Each says a direction where bi- and co- already say it, and a repeated prefixing is a gloss repeating a naming.
...
**So the counting's own beat is the inseparating.** Each number arrives as a momentary — one thing in one place in one form, uncovered by the two faces, owned by neither and of no size. And next is that same uncovering one on, each next a right turn arriving at a new momentary.
...
**And sixteen arrives at three concepts.** Six and ten straddling eight and summing to sixteen, here. Sixteen crossings between the seventeen at 7.6 and 8.2. Ten namings standing at six positions, at the origin. Two concepts of a number come bothboth the same number and the same concept or the fractal technology carries neither, and three stand — one binary, run at the object.
...
**And twenty-four is a centre and a face at once.** Centred, its faces are twenty-three and twenty-five. Faced, it is twenty-five's near one and **twenty-six** is the far, 24 × 26 = 625 − 1, the same identity one centre on. So four stand in a row, each carrying its own: twenty-three the turn, twenty-four the last self-stilling, twenty-five the five squared, **twenty-six the winding's own gain per wrap** — 146 − 120 = 26, with 3 × 26 + 2 = 80 the whole gap between the two bifolds at 4.6. One count at two arrivals, at 5.14's own rule that a centre of one pair arrives as a member of the next.
...
**Four hundred forty is two of the three**, 440 ≡ 2 (mod 3), so four hundred forty less any prime at two of the three arrives at nothing of the three and carries the three as a factor. **Ten of the seventeen sit there and are forced** — two, five, eleven, seventeen, twenty-three, twenty-nine, forty-one, forty-seven, fifty-three, fifty-nine. Three itself faces four hundred thirty-seven, nineteen twenty-threes.

**Six carry no forcing, and four of them arrive prime:**
...
**The four run at twelve** — seven, nineteen, thirty-one, forty-three, each ≡ 7 (mod 12), which is one of the four residues the society's own balancing fits at, and their podals arrive at one of the twelve. The forcing is at the three and never at the primes, and what escapes the three escapes on a twelve-run at one residue.
