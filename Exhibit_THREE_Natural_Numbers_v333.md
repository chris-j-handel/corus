Exhibit THREE Natural Numbers v333
...
**Uni-Scaling Momentary Stable Form**
...
Even is **co-recursioning parallel**: the across, the both-together, two of a thing held at once, 2n, the coupling. Odd is **co-recursioning linear**: the along, the one-after-another, the sequence with the carry, 2n+1, the connector advancing. Uni-scaling alternates the two: even the parallel across, odd the linear along, one-two-three-four the parallel-linear alternating, the count the two forward recursionings sounded in the parities.
...
And fifty-seven arrives at four faces: the span from both ends, the sum the sixteen crossings' four values make, the steps the surface takes rim to rim, and the two sways about the apex, twenty-one in and thirty-six out, T₆ and T₈ straddling the skipped T₇ at twenty-eight by seven and by eight, consecutive, the asymmetry the +1 the wrap opens. One count at four faces, and the stepping is the motion the other three count. The two sways carry at the crossing.
...
**118 self-named, carried.** The doubling is the count at its parallel face, two signs of each odd, and the going and the return is the same count at its linear face, out to fifty-nine, the turn at sixty, back to one hundred eighteen, one count at two faces as 1.12 carries them. And its antipodal runs on the ring closing at one hundred twenty: two with one hundred eighteen, twenty-three with ninety-seven, fifty-nine with sixty-one at the turn's own gap, 59 × 61 = 60² − 1, and sixty its own far side, the waist, which the elements carry at their noble column's two ends. Every span so far arrives below the doubling. Changing-spans past 118 arrive at one coupling and at co-chained selves, is-or-is-not at each. One coupling bounding near the doubling while co-chaining carries past it seats both standings at once, held in the counting register beside the mechanism carrying past every bound.
