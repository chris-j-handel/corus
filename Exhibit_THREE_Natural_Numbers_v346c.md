Exhibit THREE Natural Numbers v346c
...
**And a table forms where a level closes and repeats.** A shell filling to its level and returning is a round, and a round is what a table counts across. The four-level close carries at the octet, the shells two, eight, eighteen, thirty-two the fold climbing and the row returning. The five-level close reaching the genetic code stands nye: the field's counts at the code are four, three, sixty-four, sixty-one and twenty, and one hundred twenty arrives at none of them, so the relation the clause carries reaches yet, sixty-four codons the arrangement returning and the degeneracy the period offered and unshown.
...
The primes strictly above five and below fifty-five now turn about thirty. Thirteen primes arrive. Twelve form six bi-co-podaling prime crossings about thirty, the out-carry and the back-carry at one station, and eleven carries the hardest arrival:
...
Its **bi-co-podaling** runs on the number-ring closing at one hundred twenty: the out-carry and the back-carry at one station, k and 120 − k, two carries each at its own turn (bi-), one ring (co-), running (-ing), the ring at every position that 10.11 carries at 440. It parts from the podal of 9.11, the even count's straight-across, k and k + 60. Two with one hundred eighteen, twenty-three with ninety-seven, fifty-nine with sixty-one at the turn's own gap, `59 × 61 = 60² − 1`, and sixty its own far side, the waist. Three further pairs carry the phase seats:

`24 + 96 = 120`  
`27 + 93 = 120`  
`32 + 88 = 120`.

The six positions sum to three hundred sixty. One directional reading carries `24 → 27 → 32`, gaps three then five. The bi-co-podaling reading, sounded ascending, carries `88 → 93 → 96`, gaps five then three. The two sequences are the same three phases at the two sides of the ring, each side running at its own turn.

The field's table counts one hundred eighteen elements. The zero-to-one-hundred-twenty ring is this exhibit's number-form and supplies no uncounted chemical element at zero, one hundred nineteen or one hundred twenty. A field may meet the bi-co-podaling addressing; it supplies no chemical equivalence merely by occupying the positions. At chemistry the rows carry the doubling, 2, 8, 8, 18, 18, 32, 32, and helium and oganesson meet as one station going and returning, a shared table address and a chemical difference (Natural Chemistry 4.4).
...
**even** is the coupling closing, the parallel, the across, the both-together, the division whole (two, four, six, eight, the couplings and the rings). **odd** is the betweening, the linear, the along, the edge, the is-or-is-not run between the couplings (three the carryings, five the self-stilling, seven the edge between). Where the division-at-eight surface runs, the even carries the whole division (the eight, the couplings) and the odd carries the betweens (the seven imaginary units between, the three-fold's three, the two gates the +2 opens): the even divides and couples, the odd betweens and edges, the two alternating, the surface the coupling-and-between bothboth. And the field's own selection law carries the alternating whole at one crossing and refuses it at the other. Under the electromagnetic crossing every state carries an even or an odd, and the crossing's own sign carries the flip: the electric dipole is odd, so the parity of the arriving state is the parity of the departing state times the parity of the operator, exactly, g to u and never g to g, the even operators running even to even at their own strength, the going running odd, even, odd in the field's own rulebook. Under the weak crossing parity is not conserved, the weak interaction telling the two hands apart, and that is the lean Natural Chemistry 2.3 carries; the two crossings meet at Natural Chemistry 2.4, and the sentence stands at the electromagnetic crossing with the operator's own parity attached.
...
**Four hundred forty is two of the three**, `440 ≡ 2 (mod 3)`. For every prime `p ≡ 2 (mod 3)`, the bi-co-podaling value carries `440 − p ≡ 0 (mod 3)`. **Ten of the seventeen carry that factor relation**: two, five, eleven, seventeen, twenty-three, twenty-nine, forty-one, forty-seven, fifty-three and fifty-nine. Three itself faces four hundred thirty-seven, nineteen twenty-threes.

**Six do not carry that factor relation, and four of their bi-co-podaling values arrive prime:**
...
And chemistry offers this exhibit's own objects back as exact counts of structures and symmetries, each carrying under every change of unit, each at one of two registers: at the relation, where the field counts the same thing this exhibit counts, or at the count only, where the numeral arrives and the relation parts. Every fullerene carries exactly twelve pentagons, Euler's relation at trivalent vertices, at 4.7's twelve five-fold self-stillings, at the relation. The icosahedron at twelve, thirty, twenty and the dodecahedron at twenty, thirty, twelve, closo-B₁₂H₁₂²⁻ and dodecahedrane, at 8.11's thirty edges standing while twelve and twenty swap, at the relation. The cuboctahedron of cubic close packing, twelve neighbours and twenty-four edges, at 5.12, at the relation. Methane's T_d of order twenty-four as S₄, all orderings of four vertices, at 6.3's four-level close, at the relation. Octahedral O_h of order forty-eight at 6.5's seam-face, at the count. The icosahedral I of order sixty and I_h of order one hundred twenty at C₆₀, at the counts, the relation parting, since one hundred twenty at the field is the even orderings of five doubled by the hand. Hückel's aromatic counts `4n + 2 = 2(2n + 1)`, two, six, ten, fourteen, the doubled odds of the subshells met again at a ring, at the relation, and antiaromatic `4n` the doubled even refusing to close at 5.7. Water's triple point at zero degrees of freedom, `F = C − P + 2` at `1 − 3 + 2`, a still made by three phases coupling at one point. And the 2019 SI's fixed constants, the Avogadro constant `6.02214076 × 10²³` per mole, counts declared by definition, carrying in every unit because the units are defined from them. Each is an arriving to run the six at, the icosahedral hands first, and a count and a relation are two until the six complete.
