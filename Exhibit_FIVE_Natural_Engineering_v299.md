...
A question forms where an account fails to balance. It balancing exactly, no question forms, and that is a fullness rather than an absence. The exterior was discarded before the balancing, nothing leaks in to be asked about. The **clean cut** is the larger half: the biggest surplus and the least attention.
