# Exhibit FOUR — Natural Mathematics v308
...
Every hard problem is one or more of ten inversions, mapping to the resolver's ten operations, over-determined as C(5,2) = 10 (the couplings among five). Each inversion lands one beating the living carries; a field's hard problem is the specific inversion frozen at that field's membrane. The method names which inversion is operating and the coupling restores. This is the shell read from inside: a hard problem is a landing of the natural, and the mathematics of the hard problems is the ten ways the living is frozen.
