...
F = os.path.join(os.environ.get('CCL_WORK', os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), 'Exhibit_THIRTY_Co-Chaining_Logic_Registry_v371.md')
